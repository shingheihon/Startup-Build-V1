...
const AWSConnection = () => {
  ...
  const discoveredAssets = [
    { type: 'EC2 Instance', name: 'web-server-prod', region: 'us-east-1', publicIp: '54.123.45.67' },
    { type: 'EC2 Instance', name: 'api-server-prod', region: 'us-east-1', publicIp: '54.123.45.68' },
    { type: 'EC2 Instance', name: 'database-server', region: 'us-west-2', publicIp: '54.123.45.69' },
    { type: 'Elastic IP', name: 'eip-web-prod', region: 'us-east-1', publicIp: '54.123.45.70' },
    { type: 'Elastic IP', name: 'eip-api-prod', region: 'us-east-1', publicIp: '54.123.45.71' },
    { type: 'Route53 Domain', name: 'startup.com', region: 'global', publicIp: 'N/A' },
    { type: 'Route53 Domain', name: 'api.startup.com', region: 'global', publicIp: 'N/A' },
    { type: 'Route53 Domain', name: 'cdn.startup.com', region: 'global', publicIp: 'N/A' }
  ];
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-2">
          Connect your AWS account to automatically discover and scan your cloud assets.
        </p>
      </div>
      ...
      {!isConnected ? (
        <div className="bg-white rounded-lg border border-warm-grey p-6">
          <div className="text-center py-8">
            <Cloud className="w-16 h-16 text-orange-500 mx-auto mb-4" />
            <h2 className="text-xl font-semibold text-charcoal mb-4">Connect Your AWS Account</h2>
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              Securely connect your AWS account using OAuth to automatically discover EC2 instances,
              Elastic IPs, and Route53 domains. This provides implicit verification that you own these assets.
            </p>

            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6 max-w-2xl mx-auto">
              <h3 className="font-semibold text-green-800 mb-2">Benefits of AWS Integration:</h3>
            ...
            <button
              ...
              className="px-8 py-3 bg-orange-500 text-white rounded-lg hover:bg-orange-600 disabled:bg-gray-300 transition-colors font-medium"
            >
              {isConnecting ? 'Connecting...' : 'Connect AWS Account'}
            </button>
          </div>
        </div>
      ) : (
          ...
          <div className="bg-white rounded-lg border border-warm-grey p-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-charcoal">AWS Account Connected</h2>
                  <p className="text-sm text-gray-600">Account: startup-production (123456789012)</p>
                </div>
              </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-warm-grey">
                    ...
                    <th className="text-left py-3 px-4 font-medium text-charcoal">Region</th>
                ...
                <tbody>
                  {discoveredAssets.map((asset, index) => (
                    <tr key={index} className="border-b border-gray-100">
                      ...
                      <td className="py-3 px-4 text-sm text-gray-600">{asset.region}</td>
          ...
          <div className="bg-white rounded-lg max-w-md w-full">
            <div className="p-6">
              <div className="text-center mb-6">
                ...
                <h2 className="text-xl font-bold text-charcoal">AWS Authorization</h2>
                <p className="text-gray-600 mt-2">SafeSurf wants to access your AWS account</p>
              </div>

              <div className="bg-gray-50 rounded-lg p-4 mb-6">
                <h3 className="font-medium text-charcoal mb-2">This app will be able to:</h3>
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• Read EC2 instance information</li>
                  <li>• Read Elastic IP addresses</li>
                  <li>• Read Route53 domain records</li>
